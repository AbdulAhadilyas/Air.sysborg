    ...
    <>
      ...
      <div className="alert">
        <div className="alert-left">
          {classId.touched.classId && Boolean(classId.errors.classId) ?
...
<form onSubmit={classInput.handleSubmit}>
        <div className="input-add-text">
          <input type="text" placeholder="Add Item " onChange={classInput.han} />
        </div>
        ...
        <div className="button-pad">
          <div className="btn-add">
            <button className="button-36" type="submit">Submite</button>
          </div>
        </div>
          <div className="button-pad">
          ...
          <div className="button-pad">
            <div className="btn-cleare">
              <button className="button-36" type="submit">Clear All</button>
            </div>
          </div>
        </div>
      </div>
...
<div className="button-box">
  <div className="button-pad">
    <div className="btn-add">
      <button className="button-36">Submite</button>
    </div>
  </div>
  <div className="button-pad">
    <div className="image-upload">
  ...
  <div className="button-pad">
    <div className="btn-cleare">
    <button className="button-36">Clear All</button>
    </div>
  </div>
</div>
</div> */}