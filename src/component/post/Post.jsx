...
const Post = ({ text, ipAdders, time, fileType, fileUrl ,deleteItem}) => {
      ...
      <div className="info">
        ...
        <div className="equal">
          <div className="delte-button">
            ...
            <span onClick={deleteItem}><svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiSvgIcon-root MuiSvgIcon-fontSizeLarge css-1shn170" fill="#ff8686" focusable="false" aria-hidden="true" viewBox="0 0 24 24" datatestid="DeleteForeverIcon" tabIndex="-1" title="DeleteForever"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zm2.46-7.12 1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4z"></path></svg></span>
          </div>
        </div>
      </div>
